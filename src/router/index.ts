...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      name: "type",
      meta: { mode: "reception" },
      component: () => import("../views/CommodityType.vue"),
    },
    {
      path: "/search/:keyword",
      name: "search",
      ...
      children: [
        {
          path: "",
          name: "admin-index",
          component: () => import("../views/backstage/admin/Violation.vue"),
        },
        {
          path: "violation",
        ...
        },
        {
          ...
          component: () =>
            import("../views/backstage/admin/ViolationDetail.vue"),
        },
        {
          path: "report",
          name: "admin-report",
          component: () => import("../views/backstage/admin/Report.vue"),
        },
        {
          path: "report/:rno",
          name: "admin-report-detail",
          component: () => import("../views/backstage/admin/ReportDetail.vue"),
        },
        {
          path: "complaint",
          name: "admin-complaint",
          component: () => import("../views/backstage/admin/Complaint.vue"),
        },
        {
          path: "complaint/:cno",
          name: "admin-complaint-detail",
          component: () =>
            import("../views/backstage/admin/ComplaintDetail.vue"),
        },
      ],
    },
    //用户其他设置
